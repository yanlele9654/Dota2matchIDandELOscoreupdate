...
# %%
# 从BO3的角度来计算整体的胜率情况
match_result_BO3_elo = team_id_match(match_result_BO3)
elo_team = elo_team.elo_team()
# %%
CSGO_ELO_team_score_BO3 = elo_team.team_elo_constant_elo(match_result_BO3_elo)

CSGO_team_id = set(list(match_result_BO3_elo.W_id) + list(match_result_BO3_elo.L_id))
...
CSGO_team_id['elo_score'] = CSGO_ELO_team_score_BO3
